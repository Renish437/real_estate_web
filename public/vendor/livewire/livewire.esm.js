...
function injectStyles() {
  ...
  style.innerHTML = `/* Make clicks pass-through */
    ...
    #nprogress .bar {
      background: var(--livewire-progress-bar-color, #b968ff);
    ...
    #nprogress .peg {
      ...
      width: 100px;
      height: 100%;
      box-shadow: 0 0 10px var(--livewire-progress-bar-color, #b968ff), 0 0 5px var(--livewire-progress-bar-color, #b968ff);
      opacity: 1.0;
    ...
    #nprogress .spinner-icon {
      ...
      border-top-color: var(--livewire-progress-bar-color, #b968ff);
      border-left-color: var(--livewire-progress-bar-color, #b968ff);
      border-radius: 50%;
